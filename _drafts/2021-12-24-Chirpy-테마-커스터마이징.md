...
* 관련글 : [Jekyll Chirpy 테마 사용하여 블로그 만들기](https://www.irgroup.org/posts/jekyll-chirpy/){:target="_blank"}
* 이글 : **Chirpy 테마 커스터마이징**
...
그래서 [utterance](){:target="_blank"}를 적용해 보도록 하겠습니다.  
자세한 내용은 아래 포스트에서 확인하면 됩니다.  
* [Jekyll 테마에 utterance 댓글 연동하기](){:target="_blank"}
